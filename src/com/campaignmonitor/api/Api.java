 ...
 * 
 */
@WebServiceClient(name = "api", targetNamespace = "http://api.createsend.com/api/", wsdlLocation = Api.CAMPAIGN_MONITOR_WSDL_URL)
public class Api
    extends Service
{
	public final static String CAMPAIGN_MONITOR_WSDL_URL = "http://api.createsend.com/api/api.asmx?wsdl";
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, Api.CAMPAIGN_MONITOR_WSDL_URL);
        } catch (MalformedURLException e) {
            logger.warning(String.format(
            		"Failed to create URL for the wsdl Location: '%s', retrying as a local file", 
            		Api.CAMPAIGN_MONITOR_WSDL_URL));
